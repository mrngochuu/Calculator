...
public class Calculator extends javax.swing.JFrame {
    ...
    private boolean flag = false; //to check for any results on the screen
    ...
    public void printIntegerOrDouble() {
        if (ans == (int) ans) {
    ...
    public void checkResultOnDisplay() {
        //If a result of the calculation on the screen, continue input number so delete and re-enter
        if (flag) {
            jTextField1.setText("");
            flag = false;
        }
    ...
    public void arithmeticOperation() {
        switch (calculation) {
            ...
            case 4:
                double anotherNum = Double.parseDouble(jTextField1.getText());
                if (anotherNum == 0) {
                    JOptionPane.showMessageDialog(null, "Cannot devide by zero", "Warning", JOptionPane.WARNING_MESSAGE);
                    removeAllText();
                } else {
                    ans = num / anotherNum;
                }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // if jTextField is Empty, so 0 + other number 
        if (jTextField1.getText().isEmpty()) {
            num = 0;
        } else {
            // To continue compute without use =
